...
class ST_GCN_TSA1(nn.Module):
    ...
    def __init__(self,
        ...
        self.st_gcn_networks_S = nn.ModuleList((
            st_gcn_block(in_channels,64,kernel_size,isStgcn=True,stride=1,residual=False,**kwargs0),
            st_gcn_block(64, 64, kernel_size, isStgcn=True,stride=1, **kwargs),
            st_gcn_block(64, 64, kernel_size, isStgcn=True,stride=1, **kwargs),
            st_gcn_block(64, 64, kernel_size, isStgcn=True,stride=1, **kwargs),
            st_gcn_block(64, 128, kernel_size, isStgcn=True,stride=2, **kwargs),
            st_gcn_block(128, 128, kernel_size,isStgcn=True,stride= 1, **kwargs),
            st_gcn_block(128, 128, kernel_size, isStgcn=True,stride=1, **kwargs),
            st_gcn_block(128, 256, kernel_size,isStgcn=True,stride= 2, **kwargs),
            st_gcn_block(256, 256, kernel_size,isStgcn=True,stride= 1, **kwargs),
            st_gcn_block(256, 256, kernel_size,isStgcn=True,stride= 1, **kwargs),
        ))
    ...
    def forward(self, x):
        ...
        A = ALN_out.cuda()
        for gcn, importance in zip(self.st_gcn_networks_A, self.edge_importance_A):
        ...
        # STGCN
        for gcn, importance in zip(self.st_gcn_networks_S, self.edge_importance_S):
