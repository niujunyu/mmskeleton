...
class ST_GCN_ALN30(nn.Module):
    ...
    def forward(self, x):
        ...
        convA,sliceA = self.ALN(input_ILN)
        uniA = self.A.view(1,1,25,25).repeat(N*M,1,1,1)
        A = torch.cat((uniA,convA,sliceA),dim=1)
